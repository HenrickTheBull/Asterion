...
class AsterHelp(DefaultHelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        embed.set_author(
            name="Asterion The Discord Bot", icon_url=self.context.bot.user.avatar_url, url=configs.info.homepage)
        embed.set_footer(text="| Henrick The Bull", icon_url=configs.info.brand_logo)
        ...
        embed.add_field(name="Support Us", value=f"{arrow} [Sponsus]({configs.info.sponsus})\n"
                                                 f"{arrow} [Ko-Fi]({configs.info.kofi})\n"
